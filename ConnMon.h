...
#ifndef LIB_CONNMON_H_
#define LIB_CONNMON_H_
...
public:
  ...
  virtual void notifyAppProtocolConnected(bool isAppProtocolConnected) { }
...
public:
  ...
  void evaluateState();
  void setAppProtocolState(bool appProtocolIsConnected);
...
public:
  ...
  void evaluateState(ConnMon* monitor);
  void evaluateState(ConnMon* monitor, bool appProtocolState);
  void entry(ConnMon* monitor);
  const char* toString();
